...
router.get("/:doctorId/patients", isLoggedIn,  async (req, res) => {
...
router.get("/:doctorId/appointments", isLoggedIn,  async (req, res) => {
  let { doctorId } = req.params;
...
router.get("/:doctorId/details", isLoggedIn, async (req, res) => {
  let { doctorId } = req.params;
  let doctor = await Doctor.findById(doctorId);
  res.json(doctor);
});

router.post("/addDiagnosis/:appointmentId", isLoggedIn, async (req, res) => {
